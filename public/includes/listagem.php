    <section class="container text-dark bg-light ml-5 pb-1 fs-5 rounded" style="width: 80%; height:min-content;">
        <?php
            ...
            <div class="row bg-light d-flex align-items-center text-center lines">
                <div class="col-4">
