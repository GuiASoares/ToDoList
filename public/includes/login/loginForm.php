<?php
    $mensagemErro = '';
    if(isset($_GET['erro']) && $_GET['erro'] == 'naoPreenchidos'){
    ...
    } else if(isset($_GET['erro']) && $_GET['erro'] == 'invalidos'){
    ...
    <div class="card bg-light rounded mt-3" id="formContainer">
        <form action="../../src/controllers/checagemLogin.php" method="post" class="text-dark">
            ...
            <div class="card-body">
                ...
                <input type="password" id="senhaInput" class="form-control mb-2" name="senha" minlength="6" required>
