<main class="container d-flex mt-5" style="gap:20px;">
    <div class="row w-100 m-0">
        ...
        <div class="col-md-10">
            <table class="text-dark bg-light pb-1 fs-5 table rounded overflow-hidden" style="height:min-content;">
                ...
                <?php
                    ...
                    <thead class="text-center" id="tableTitle">
                        <tr>
                            <th scope="col" class="fw-bold m-1">Descrição</th>
                            <th scope="col" class="fw-bold m-1">Data</th>
                            <th scope="col" class="fw-bold m-1">Ações</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody id="table">
                    ...
                    ?>
                        ...
                        <tr class="text-center lines" style="margin-right: 0; flex-wrap: nowrap;">
                            ...
                            <?php if($tarefa['situacao'] == 'pendente'){?>
                                ...
                                <div class="d-flex justify-content-center gap-1 w-100 h-100">
                            ...
                            <?php } else { ?>
                                ...
                                <td class="text-secondary text-center">Concluída</td>
                                </div>
